...
# nabPath = "/Users/seeker/TNwork/nabonlineanalysis/pyNablat/pyNab/src"
...
class MData:
    ...
    def getdatafromfile(self):
        ...
        self.hdFile = Nab.DataRun(
            self.runpath, self.runno
        )  # We will have to chnage this later so user can input the run number
    ...
    def getDetPixData(self, eventType, det="top"):
        ...
        self.pixhist = self.hdFile.plotHitLocations(
            self.eventType,
            size=1.3,
            det=det,
            rounding="int",
